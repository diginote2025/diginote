...
// Single-file Next.js + Tailwind blog content page
// - Default export is a React component that accepts a `post` prop (HTML content expected)
// - Includes: hero, meta (author, date, read time), sticky TOC, related posts sidebar, share buttons,
//   reading progress bar, responsive layout, accessibility considerations.
